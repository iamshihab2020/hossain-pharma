  ...
  const handleDeleteProduct = (id) => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        axiosSecure.delete(`/seller/ads/${id}`).then((res) => {
            ...
            <tr key={index}>
              ...
              <td className={classes}>
                <div className="flex flex-col">
                  ...
                  >
                    <div className="w-20">
                      {product.adsStatus === "rejected" ? (
                        <Chip
                          value={product.adsStatus}
                          size="sm"
                          color="red"
                          className="rounded-full text-center"
                        />
                      ) : product.adsStatus === "pending" ? (
                        <Chip
                          value={product.adsStatus}
                          size="sm"
                          color="orange"
                          className="rounded-full text-center"
                        />
                      ) : product.adsStatus === "accepted" ||
                        !product.adsStatus ? (
                        <Chip
                          value={product.adsStatus || "accepted"}
                          size="sm"
                          color="green"
                          className="rounded-full text-center"
                        />
